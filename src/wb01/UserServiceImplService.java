 ...
 * 
 */
@WebServiceClient(name = "UserServiceImplService", targetNamespace = "http://wb01/", wsdlLocation = "http://127.0.0.1:8089/sayHello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICEIMPLSERVICE_QNAME = new QName("http://wb01/", "UserServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:8089/sayHello?wsdl");
    ...
    public UserServiceImpl getUserServiceImplPort() {
        return super.getPort(new QName("http://wb01/", "UserServiceImplPort"), UserServiceImpl.class);
    }
    ...
    public UserServiceImpl getUserServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://wb01/", "UserServiceImplPort"), UserServiceImpl.class, features);
    }
