 ...
 * 
 */
@WebServiceClient(name = "UserServiceImplService", targetNamespace = "http://wb02/", wsdlLocation = "http://127.0.0.1:8089/sayHello2?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICEIMPLSERVICE_QNAME = new QName("http://wb02/", "UserServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:8089/sayHello2?wsdl");
    ...
    public UserServiceImpl getUserServiceImplPort() {
        return super.getPort(new QName("http://wb02/", "UserServiceImplPort"), UserServiceImpl.class);
    }
    ...
    public UserServiceImpl getUserServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://wb02/", "UserServiceImplPort"), UserServiceImpl.class, features);
    }
